  ...
  return `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2 class="logo">CJP</h2>
          </div>
          <div class="content">
            ${content}
          </div>
          <div class="footer">
            <div class="footer-logo">CJP Ltd.</div>
...
export const getOtpTemplate = (name, otpCode) => {
  const content = `
    ...
    <p>Dear ${name},</p>
    <p>Thank you for creating an account with CJP. To finalize your registration and secure your profile, please verify your email address using the one-time passcode (OTP) below. This OTP is valid for 15 minutes.</p>
  ...
  `;
  return emailWrapper('Verify Your Email - CJP', content);
};
...
export const getResetTemplate = (name, resetUrl) => {
  const content = `
    ...
    <p>Dear ${name},</p>
    <p>You are receiving this email because a request was submitted to reset the password for your account on CJP. Please click the button below to complete the process. This link is valid for 15 minutes.</p>
  ...
  `;
  return emailWrapper('Reset Password - CJP', content);
};
