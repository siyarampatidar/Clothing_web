      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-luxury-gray mt-1">
            Supervise garments catalog, manage prices, stock levels, and customize attributes.
          </p>
        </div>
          ...
          >
            ...
            <p className="text-xs text-luxury-gray max-w-sm mx-auto mb-6">
              {searchQuery || categoryFilter || statusFilter 
                ...
                : "No products exist inside your database registry. Click Add Product to design your first garment."}
            </p>
            {!searchQuery && !categoryFilter && !statusFilter && (
              <button
                onClick={() => setIsAddModalOpen(true)}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-xs text-luxury-gray mb-6">
                Register new apparel to the store, configure pricing, upload image cards, and specify variables.
              </p>
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <textarea
                        ...
                        placeholder="Short summary of the apparel garment (maximum 150 chars)..."
                        required
                        rows="2"
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        placeholder="Comprehensive details, wash instructions, fabric specs, shipping guidelines..."
                        required
                        rows="4"
                        className="w-full p-4 text-xs bg-[#faf9f6] border border-[#ece9df] rounded-xl outline-none focus:border-[#c5a059] transition placeholder:text-zinc-400"
                      />
