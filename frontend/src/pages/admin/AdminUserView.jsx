          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <p className="text-xs text-luxury-gray mb-6">
                Are you sure you want to delete <strong className="text-zinc-900">"{deleteTarget.name}"</strong>? This will permanently erase their profile and files from the ClothingWeb database. This action is irreversible.
              </p>
